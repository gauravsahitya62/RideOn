...
export default function AuthGate() {
  ...
  if (!user || !['customer', 'vendor', 'support', 'admin'].includes(user.role)) return <AuthScreen onAuthenticated={handleAuthenticated} />;
  if (user.role === 'admin' || user.role === 'support') return <AdminDashboardScreen user={user} onLogout={signOut} />;
