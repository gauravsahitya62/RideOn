...
export default function PaymentMethodSelector({value,onChange,disabled=false}){
 ...
 return <View style={styles.card}>
  ...
  <TouchableOpacity disabled={disabled} onPress={()=>onChange?.('demo')} style={[styles.option,selected&&styles.active]} accessibilityRole="radio" accessibilityState={{selected}}>
