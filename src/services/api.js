...
export const rideOnApi = {
  ...
  updatePreferences: (payload) => request('/api/v1/me/preferences', { method:'PATCH', body:JSON.stringify(payload) }),
  submitSupportRequest: (payload) => request('/api/v1/support/requests', { method:'POST', body:JSON.stringify(payload) }),
